//Week 4 of 11 April 22, 2026 - April 28, 2026
...
// PUT YOUR CODE HERE
//create function: convertTemp
//1 C parameter converts to F
//(0°C × 9/5) + 32
...
console.log("Q1 convertTemp: ", 34, convertTemp(34));
console.log("Q1 convertTemp: ", 100, convertTemp(100));
...
//1 string param
//returns reverseString = new string
//for loop
...
function reverseString(inputString) {
  ...
  return reversed; //always return to get your output
}
...
function tipCalculator(billTotal, tipPercentage) {
  ...
  const newBillTotal = billTotal + tipAmount;
  return newBillTotal;
}
...
// PUT YOUR CODE HERE
// if a number is/is not divisible by 2
let number = 12;
...
// PUT YOUR CODE HERE
//takes integer returns array of all primes <=
...
console.log("Q7 getPrimesUpTo:", 56, getPrimesUpTo(56));

console.log("Q7 getPrimesUpTo:", 200, getPrimesUpTo(200));
...
scores = [-190, -80, -85];
console.log("Q8 invalid:", calculateAverage(scores));
scores = [190, 80, 85];
...
console.log("Q9 getLetterGrade:", 65, getLetterGrade(65));
console.log("Q9 getLetterGrade:", 75, getLetterGrade(75));
console.log("Q9 getLetterGrade:", 82, getLetterGrade(82));
console.log("Q9 getLetterGrade:", 105, getLetterGrade(105));
console.log("Q9 getLetterGrade:", -10, getLetterGrade(-10));
...
function printClassResult(className, student, scores) {
  const averageResult = calculateAverage(scores);
  const gradeResult = getLetterGrade(averageResult);
  let passedResult = passed(gradeResult);
  if (passedResult === true) {
    passedResult = "yes";
  } else {
    passedResult = "no";
  }
  return `${className} - Student: ${student}, Average: ${averageResult}, Grade: ${gradeResult}, Passed: ${passedResult}`;
}
