//Week 2 of 11 April 08, 2026 - April 14, 2026
...
//create a loop, remove vowels from a string loop
//remove vowels - read every letter, yes/no vowels
...
// input: number
// output: number of odds 0 <= number
...
// PUT YOUR CODE HERE
//1st assign full array to new array using slice method, then compare length of two array, then using loop compare each item from both arrays 
//Just create a new empty array and push the value and return the new array
//look up the array method called every()
...
function compareArrays(arr1, arr2) {
    ...
    if (arr1.length !== arr2.length) {
        ...
        // loop through both arrays to compare each value
    ...
    // so if it passes both the length check
    // and the array values check
...
// ---------- QUESTION 10 ----------
//for loop or while loops to work with arrays 
...
// PUT YOUR CODE HERE
//variable numbers = array w 3 elements
//write function calculateTotal
//takes one array param and loops through array
